...
ORYX.I18N.Oryx.noBackendDefined	= "Caution! \nNo Backend defined.\n The requested modules cannot be loaded. Try to load a configuration with a save plugin.";
...
ORYX.I18N.EPCSupport.progressExp = "Exporting modules";
...
ORYX.I18N.ERDFSupport.deprText = "Exporting to eRDF is not recommended anymore because the support will be stopped in future versions of the Oryx editor. If possible, export the modules to JSON. Do you want to export anyway?";
...
ORYX.I18N.jPDLSupport.expFailedReq = "Request for export of modules failed.";
...
ORYX.I18N.File.printDesc = "Print current modules";
...
ORYX.I18N.View.zoomInDesc = "Zoom into the modules";
ORYX.I18N.View.zoomOut = "Zoom Out";
ORYX.I18N.View.zoomOutDesc = "Zoom out of the modules";
ORYX.I18N.View.zoomStandard = "Zoom Standard";
ORYX.I18N.View.zoomStandardDesc = "Zoom to the standard level";
ORYX.I18N.View.zoomFitToModel = "Zoom fit to modules";
ORYX.I18N.View.zoomFitToModelDesc = "Zoom to fit the modules size";
...
ORYX.I18N.JSONSupport = {
    imp: {
        ...
        desc: "Imports a modules from JSON",
        group: "Export",
    ...
    exp: {
        name: "Export to JSON",
        desc: "Exports current modules to JSON",
        group: "Export"
    }
};
...
ORYX.I18N.RDFExport.rdfExportDescription = "Exports current modules to the XML serialization defined for the Resource Description Framework (RDF)";
