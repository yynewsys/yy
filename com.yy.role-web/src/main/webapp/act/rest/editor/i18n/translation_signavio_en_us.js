...
ORYX.I18N.ERDFSupport.deprText = "Exporting to eRDF is not recommended anymore because the support will be stopped in future versions of the Signavio Process Editor. If possible, export the modules to JSON. Do you want to export anyway?";
...
ORYX.I18N.Save.noRights = "You do not have the required rights to store that modules. Please check in the <a href='/p/explorer' target='_blank'>Signavio Explorer</a>, if you still have the rights to write in the target directory.";
...
Signavio.I18N.Editor.Linking.AlertSelectModel = "You have to select a modules.";
