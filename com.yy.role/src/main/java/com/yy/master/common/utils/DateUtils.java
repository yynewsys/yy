...
public class DateUtils extends org.apache.commons.lang3.time.DateUtils {
	 ...
	 * @return
	 */
	public static String  getTormmorow(){
...
//		System.out.println(time/(24*60*60*1000));
	...
	public static double getDistanceOfTwoDate2(Date before, Date after) {
		...
		String s=dateFormater.format(before);
		String ss=dateFormater.format(after);
		try {
			before = dateFormater.parse(s);
			after = dateFormater.parse(ss);
		} catch (ParseException e) {
			e.printStackTrace();
		}
		long beforeTime = before.getTime();
