 ...
 * jims.
 */
package com.yy.master.modules.gen.util;
...
import com.yy.master.common.utils.FreeMarkers;
...
import com.yy.master.common.mapper.JaxbMapper;
import com.yy.master.common.utils.FileUtils;
import com.yy.master.modules.gen.entity.GenCategory;
...
//		}
	...
	public static Map<String, Object> getDataModel(GenScheme genScheme){
		...
		model.put("viewPrefix", //StringUtils.substringAfterLast(modules.get("packageName"),".")+"/"+
				model.get("urlPrefix"));
