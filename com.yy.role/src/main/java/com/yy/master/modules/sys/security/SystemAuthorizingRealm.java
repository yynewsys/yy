 ...
 * jims.
 */
package com.yy.master.modules.sys.security;
...
//		private Map<String, Object> cacheMap;
		...
		public Principal(User user, boolean mobileLogin) {
			this.id = user.getId();
			this.loginName = user.getCurrentLogin();
